...
public class MainActivity extends AppCompatActivity implements RecyclerView.OnItemTouchListener, IdeaAdapter.CheckButtonListener {
    ...
    //Waarom er altijd voor 1234 wordt gekozen blijft me een raadsel xD
    public static final int REQUEST_CODE = 1234;
    public static final String EXTRATEXT_NAME = "title";
    public static final String EXTRATEXT_DESCRIPTION = "descripion";
    ...
    private void initFloatingActionButton() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, AddIdea.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.drawable.delete_forever_outline) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (REQUEST_CODE == requestCode) {
            if (resultCode == RESULT_OK) {
                String title = data.getStringExtra(EXTRATEXT_NAME);
                String desc = data.getStringExtra(EXTRATEXT_DESCRIPTION);
